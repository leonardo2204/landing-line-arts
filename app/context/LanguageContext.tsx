...
const translations = {
  'en': {
    ...
    'landing.banner.newFeature': 'New feature:',
    'landing.banner.stickers': 'Create stickers!',
    'landing.banner.tryNow': 'Try now',
    'landing.hero.title': 'Photo to sketch',
    'landing.hero.titleHighlight': 'art generator',
    'landing.hero.subtitle': 'Turn your favorite memories into stunning sketch art in seconds. Bobbie Goods style :D',
    'landing.stickers.title': 'Create custom stickers',
    'landing.stickers.subtitle': 'Transform your favorite memories into unique, personalized stickers perfect for decorating anything',
    'landing.stickers.example1Title': 'Family moments',
    'landing.stickers.example1Description': 'Turn your family photos into adorable stickers for scrapbooks and gifts',
    'landing.stickers.example2Title': 'Pet portraits',
    'landing.stickers.example2Description': 'Create cute stickers of your beloved pets for laptops and phones',
    'landing.stickers.example3Title': 'Special occasions',
    'landing.stickers.example3Description': 'Commemorate birthdays, weddings, and celebrations with custom stickers',
    'landing.stickers.ctaButton': 'Create custom stickers',
    'landing.seeTheMagic': 'See the magic in action',
    'landing.seeTheMagicSubtitle': 'See how our AI transforms ordinary photos into extraordinary coloring pages',
  ...
  'pt-BR': {
    ...
    'landing.banner.newFeature': 'Novidade:',
    'landing.banner.stickers': 'Crie adesivos personalizados!',
    'landing.banner.tryNow': 'Experimente agora',
    'landing.hero.title': 'Transforme suas fotos em esboços ',
    'landing.hero.titleHighlight': 'artísticos digitais',
    'landing.hero.subtitle': 'Crie artes digitais maravilhosas — Sketch Art feito por Brasileiros, para Brasileiros, em poucos cliques. Seu Bobbie Goods próprio, criado por você!',
    'landing.stickers.title': 'Crie adesivos personalizados',
    'landing.stickers.subtitle': 'Transforme suas memórias favoritas em adesivos únicos e personalizados, perfeitos para decorar qualquer coisa, inclusive seu WhatsApp ou Telegram',
    'landing.stickers.example1Title': 'Momentos em família',
    'landing.stickers.example1Description': 'Transforme suas fotos de família em adesivos adoráveis para álbuns e presentes',
    'landing.stickers.example2Title': 'Retratos de pets',
    'landing.stickers.example2Description': 'Crie adesivos fofos dos seus pets queridos para laptops e celulares',
    'landing.stickers.example3Title': 'Ocasiões especiais',
    'landing.stickers.example3Description': 'Comemore aniversários, casamentos e celebrações com adesivos personalizados',
    'landing.stickers.ctaButton': 'Criar adesivos personalizados',
    'landing.seeTheMagic': 'Veja a mágica acontecer',
    'landing.seeTheMagicSubtitle': 'Veja como nossa IA transforma fotos comuns em extraordinárias páginas para colorir, estilo Bobbie Goods',
