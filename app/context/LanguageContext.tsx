...
const translations = {
  'en': {
    ...
    'landing.hero.title': 'Create coloring books',
    'landing.hero.titleHighlight': ' and stickers from photos',
    'landing.hero.subtitle': 'Our AI technology turns your favorite pictures into personalized coloring pages, nice stickers, creating unique, memorable experiences.',
