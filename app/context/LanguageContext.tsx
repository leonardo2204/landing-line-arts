...
const translations = {
  ...
  'pt-BR': {
    ...
    'landing.hero.title': 'Gere adesivos e livros de colorir',
    'landing.hero.titleHighlight': 'estilo Bobbie Goods',
    'landing.hero.subtitle': 'Nossa tecnologia de IA transforma suas fotos favoritas em páginas para colorir, ou adesivos, criando experiências únicas e memoráveis. E o melhor, é só imprimir e colorir!',
