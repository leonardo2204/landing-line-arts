...
const translations = {
  'en': {
    ...
    'landing.banner.stickers': 'We now have stickers!',
    'landing.banner.tryNow': 'Try now',
    'landing.hero.title': 'Transform your photos into beautiful',
    'landing.hero.titleHighlight': 'coloring books and stickers',
  ...
  'pt-BR': {
    ...
    'landing.banner.stickers': 'Agora geramos adesivos personalizados!',
    'landing.banner.tryNow': 'Experimente agora',
    'landing.hero.title': 'Transforme suas fotos em lindos',
    'landing.hero.titleHighlight': 'livros de colorir e adesivos',
    'landing.hero.subtitle': 'Nossa tecnologia de IA transforma suas fotos favoritas em páginas para colorir ou adesivos, criando experiências únicas e memoráveis para todas as idades. E o melhor, é só imprimir e colorir!',
